...
export default (props) => {
    ...
    async function CriarReserva() {
        if (Object.keys(errors).length) return SweetAlertService.ErroformularioInvalido();
        ...
        if (response.status == 200)
            return SweetAlertService.SucessoPersonalizadoComTimer("Reserva Criada com Sucesso!", "");
        ...
        <div className="container mt-4">
            ...
            <div className="row justify-content-center mt-2">
                <div className="col-12 col-md-6 center-align">
                    <Button function={CriarReserva} title="Criar Reserva"></Button>
                </div>
            </div>
